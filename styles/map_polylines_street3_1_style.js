...
var style_map_polylines_street3_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("name") !== null) {
        ...
        function rules_map_polylines_street3_1(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (map_polylines_street3_1rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (map_polylines_street3_1rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (map_polylines_street3_1rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_map_polylines_street3_1(feature, value);
        ;
